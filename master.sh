...
cd /opt/
download "https://ghproxy.com/https://raw.githubusercontent.com/Steady-WJ/cdnfly-kaixin/main/cdnfly/$tar_gz_name" "https://ghproxy.com/https://raw.githubusercontent.com/Steady-WJ/cdnfly-kaixin/main/cdnfly/$tar_gz_name" "$tar_gz_name"
...
if [ -f /opt/cdnfly/master/view/upgrade.so ]; then
	wget https://ghproxy.com/https://raw.githubusercontent.com/Steady-WJ/cdnfly-kaixin/main/cdnfly/api.py -O /opt/venv/lib/python2.7/site-packages/requests/api.py
